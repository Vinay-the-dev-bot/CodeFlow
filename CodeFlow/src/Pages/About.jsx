  ...
  return (
    <Box p={6}>
      ...
      <Box bg="gray.100" p={4} borderRadius="md" mb={4}>
        ...
        <Text>
          At CodeFlow, we're on a mission to democratize coding by providing a platform where collaboration, learning, and creativity thrive. We believe that coding is not just about writing lines of code but about building connections, sharing knowledge, and fostering innovation.
        </Text>
      </Box>
      ...
      <Box bg="gray.100" p={4} borderRadius="md" mb={4}>
        ...
        <Text>
          CodeFlow isn't just another coding platform; it's a community-driven ecosystem designed to empower coders of all levels. Whether you're a seasoned developer looking for new challenges or a beginner eager to learn, CodeFlow offers the tools and resources you need to succeed.
        </Text>
        <Text>
          Join us as we revolutionize the way coders work, learn, and collaborate. Welcome to the future of coding—welcome to CodeFlow.
        </Text>
      </Box>
    </Box>
  );
